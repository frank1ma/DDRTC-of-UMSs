...
%         sortptgcfdt=sort(ptgcfdt);
%         for k = 1:size(ptgcfdt,1)
%             order=find(sortptgcfdt==ptgcfdt(k));
%             ptgcfdt(k)=order(1)/size(ptgcfdt,1);
%         end
